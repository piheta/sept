...
<div class="flex items-center h-14 w-full">
    ...
    <h1 class="pl-1 pr-1 mr-2 ml-2 rounded-md text-[1.25rem] flex-grow font-medium h-16 flex justify-start items-center select-text">{$selection_store.name}</h1>

    <button onclick={() => {}} class="relative w-10 h-10 mr-1 rounded-md flex items-center justify-center cursor-pointer transition-all duration-50 ease-in-out bg-opacity-0 hover:bg-opacity-5 hover:bg-gray-200">
    ...
    <button onclick={() => {}} class="relative w-10 h-10 mr-2 rounded-md flex items-center justify-center cursor-pointer transition-all duration-50 ease-in-out bg-opacity-0 hover:bg-opacity-5 hover:bg-gray-200">
