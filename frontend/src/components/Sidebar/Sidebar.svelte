...
<div class="flex flex-col h-full">
    <div class="flex-shrink-0">
        ...
        >
            <button on:click={() => {sidebar_mode = 0; searchQuery=""}} class:!mt-2={small} class="relative w-full h-12 rounded-md flex items-center justify-center cursor-pointer">
            ...
            <button on:click={() => {sidebar_mode = 1; searchQuery=""}} class="relative w-full h-12 rounded-md flex items-center justify-center cursor-pointer">
            ...
            <button on:click={() => {sidebar_mode = 2; searchQuery=""}} class:hidden={small} class="relative w-full h-12 rounded-md flex items-center justify-center cursor-pointer">
