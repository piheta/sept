...
<div>
    ...
    <div class="flex justify-center items-center gap-2 ml-2">
      <button on:click={() => {sidebar_mode = 0}} class="relative w-full h-16 bg-gray-900 rounded-md flex items-center justify-center cursor-pointer">
        ...
        {#if sidebar_mode === 0}<div class="absolute z-50 w-4 h-1 bottom-2 rounded-sm bg-[#11FFEE]"></div>{/if}
      </button>

      <button on:click={() => {sidebar_mode = 1}} class="relative w-full h-16 bg-gray-900 rounded-md flex items-center justify-center cursor-pointer">
      ...
      <button on:click={() => {sidebar_mode = 2}} class="relative w-full h-16 bg-gray-900 rounded-md flex items-center justify-center cursor-pointer">
