...
<div class="h-full w-full rounded-md p-2 flex flex-col shadow-xl" style="background-color: rgba(17, 24, 39, 0.5);">
    <div class="flex -ml-0.5 *:mr-1">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="-ml-0.5" width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor"><path d="M15 20H7V18H9.92661L12.0425 6H9V4H17V6H14.0734L11.9575 18H15V20Z"></path></svg>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="ml-5" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2s4-2 4-2M9 9h.01M15 9h.01"/></g></svg>
    ...
    <textarea
        ...
        class="w-full resize-none m-0 mt-1 focus:outline-none active:outline-none flex-grow text-[0.95rem]"
